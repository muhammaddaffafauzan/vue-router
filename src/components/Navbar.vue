<template>
  <ul>
    ...
    <li>
      <router-link :class="{ active: rl_6 }" :to="{ name: 'Counter' }"
        >Counter</router-link>
    </li>
    <li style="margin-left: 50%;">
      <router-link :class="{ active: rl_7 }" :to="{ name: 'Login' }"
        >Login</router-link>
    </li>
    <li>
      <router-link :class="{ active: rl_8 }" :to="{ name: 'Register' }"
